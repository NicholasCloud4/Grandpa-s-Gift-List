...
function checkDuplicate() {
    ...
    let normalizedItem = itemInput.value.trim().replace(spaceRegex, " ").toLowerCase();

    // Check if the normalized item is already in the list
    if (listArr.some((item) => item.toLowerCase() === normalizedItem)) {
